...
import { allProducts, PromotionProgramResponse, PromotionPrograms } from '../../../models/responses/promotion/promotion-response';
...
@Component({
  selector: 'ngx-list-edit-promotion-program',
  templateUrl: './list-edit-promotion-program.component.html',
  styleUrls: ['./list-edit-promotion-program.component.scss'],
  animations: [
    trigger('listProgram', [
...
export class ListEditPromotionProgramComponent implements OnInit{
  ...
  @Input() listPromotionProgram: PromotionPrograms[] = [];
