...
export class SupportService {
  ...
  getSupports(): Observable<ResponseApi<ListSupportResponse[]>> {
    return this.http
      .get<ResponseApi<ListSupportResponse[]>>(this.apiURL + "GetSupports")
      .pipe(
        map((response: ResponseApi<ListSupportResponse[]>) => {
  ...
  create(request: CreateSupportRequest): Observable<ResponseApi<string>> {
    return this.http
      .post<ResponseApi<string>>(this.apiURL + "CreateSupport", request)
      .pipe(
  ...
  edit(request: EditSupportRequest): Observable<ResponseApi<string>> {
    return this.http
      .put<ResponseApi<string>>(this.apiURL + "UpdateSupport", request)
      .pipe(
        tap((response: ResponseApi<string>) => {
          if (response.isSuccessed) {
            return response;
  ...
  //Chi tiết bệnh
  details(
    request: DetailsSupportRequest
  ): Observable<ResponseApi<SupportResponse>> {
    ...
    return this.http.get(this.apiURL + "DetailsSupport", { params }).pipe(
  ...
  delete(supportId: string): Observable<ResponseApi<string>> {
    ...
    return this.http
      .delete<ResponseApi<string>>(this.apiURL + "DeleteSupport", { params })
      .pipe(
        tap((response: ResponseApi<string>) => {
          if (response.isSuccessed) {
            return response;
  ...
  // Product Select
  getSupportSelect(): Observable<ResponseApi<SelectSupportResponse[]>> {
    return this.http
      .get<ResponseApi<SelectSupportResponse[]>>(
        this.apiURL + "GetSupportSelect"
      )
      .pipe(
        tap((response: ResponseApi<SelectSupportResponse[]>) => {
          if (response.isSuccessed) {
            return response;
          } else {
            this.errorNotify.handleStatusError(response.code);
